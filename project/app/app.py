...
def home():
    if request.method == 'POST':
        ...
        input_datetime = datetime.strptime(input_date_str + " " + input_hour_str,"%Y-%m-%d %H") 
        try:
            traf_data = int(data.loc[data.index == input_datetime, 'Total_trafikk'].values[0])
        ...
        return render_template('home.html', traffic_data=traf_data, traffic_image=traffic_image)
